...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : ERR_LED_1_Pin ERR_LED_2_Pin ERR_BUZZER_1_Pin ERR_BUZZER_2_Pin */
  GPIO_InitStruct.Pin = ERR_LED_1_Pin|ERR_LED_2_Pin|ERR_BUZZER_1_Pin|ERR_BUZZER_2_Pin;
